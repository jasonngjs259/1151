...
//       mainCursor.current.style.transfrom = `translate3d(${mouseX - mainCursor.current.clientWidth / 2}px, ${mouseY - mainCursor.current.clientHeight / 2}px, 0)`;
//     });
...
//       secondaryCursor.current.style.transfrom=`translate3d(${destinationX}px, ${destinationY}px, 0)`;
//     }
//   })
