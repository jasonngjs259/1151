...
const App = () => {
    ...
    const touchMove = (e) => {
        ...
        if (cuttingArea.clientWidth >= cuttingArea.clientHeight) {
            if (e.touches[0].clientX < cuttingArea.getBoundingClientRect().left ||
                e.touches[0].clientX > cuttingArea.getBoundingClientRect().left + cuttingArea.clientWidth)
            {
                console.log("Y: " + false);
                endPointY = null;
            }
            ...
            if (endPointX === null &&
                (e.touches[0].clientX === cuttingArea.getBoundingClientRect().left || 
                    e.touches[0].clientX <= cuttingArea.getBoundingClientRect().left + cuttingArea.clientWidth / segment))
            {
                //   console.log("Segment: " + (cuttingArea.getBoundingClientRect().left + (cuttingArea.clientWidth / segment)))
                ...
                (e.touches[0].clientX === cuttingArea.getBoundingClientRect().left + cuttingArea.clientWidth ||
                    e.touches[0].clientX >= cuttingArea.getBoundingClientRect().left + (cuttingArea.clientWidth * (segment - 1)) / segment)) 
            {
                //   console.log("Segment: " + (cuttingArea.getBoundingClientRect().left + (cuttingArea.clientWidth * (segment - 1) / segment)))
                endPointX = cuttingArea.getBoundingClientRect().left;
                console.log("End Point X: " + endPointX);
            ...
            if (Math.round(endPointX).toFixed(0) === Math.round(e.touches[0].clientX).toFixed(0) || (Math.round(e.touches[0].clientX).toFixed(0) - startPointX) >= (Math.round(cuttingArea.clientWidth).toFixed(0)))
            {
        ...
        {
            if (e.touches[0].clientY < cuttingArea.getBoundingClientRect().top ||
                e.touches[0].clientY > cuttingArea.getBoundingClientRect().top + cuttingArea.clientHeight)
            {
                console.log("X: " + false);
                endPointX = null;
            }

            if (endPointY === null && (e.touches[0].clientY === cuttingArea.getBoundingClientRect().top ||
                e.touches[0].clientY <= cuttingArea.getBoundingClientRect().top + cuttingArea.clientHeight / segment)) 
            {
                //   console.log("Segment: " + (cuttingArea.getBoundingClientRect().top + (cuttingArea.clientHeight / segment)))
                endPointY =
            ...
            else if(endPointY === null && (e.touches[0].clientY === cuttingArea.getBoundingClientRect().top + cuttingArea.clientHeight || 
                e.touches[0].clientY >= cuttingArea.getBoundingClientRect().top + (cuttingArea.clientHeight * (segment - 1)) / segment)) 
            {
                //   console.log("Segment: " + (cuttingArea.getBoundingClientRect().top + (cuttingArea.clientHeight * (segment - 1) / segment)))
                endPointY = cuttingArea.getBoundingClientRect().top;
                // console.log("End Point: " + endPointY);
            ...
            if (Math.round(endPointY).toFixed(0) === Math.round(e.touches[0].clientY).toFixed(0) || (Math.round(e.touches[0].clientY).toFixed(0) - startPointY) >= (Math.round(cuttingArea.clientHeight).toFixed(0)))
            {
                console.log("Sliced: true");
                startPointY = null;
                document.getElementById("cutting-area" + (Slices.length - i)).style.display = "none";                
